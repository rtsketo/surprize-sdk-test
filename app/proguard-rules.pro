...
# AxiomCore Model
-keep class com.axiomc.core.connections.model.** { *; }
-keep class com.axiomc.core.connections.params.** { *; }
# Render Script
-keep class android.support.v8.renderscript.** { *; }
-keep class androidx.renderscript.** { *; }
# Layouts (ViewGroup based)
-keep,allowobfuscation,allowoptimization class * extends android.view.ViewGroup { *; }
...
# Google Maps (not that specific).
-keep class * extends com.google.protobuf.GeneratedMessageLite { *; }
-keep,allowobfuscation,allowshrinking class kotlin.coroutines.Continuation
##---------------Begin: proguard configuration for Retrofi  ----------
